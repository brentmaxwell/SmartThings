 ...
 */
metadata {
	definition(name: "August Z-Wave Lock (custom)", namespace: "thebrent", author: "Brent Maxwell", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "Brent Maxwell", vid: "generic-lock-2") {
		capability "Actuator"
		capability "Lock"
        capability "Polling"
		capability "Refresh"
