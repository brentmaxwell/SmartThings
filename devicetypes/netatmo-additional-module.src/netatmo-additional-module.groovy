metadata {
	definition (name: "Netatmo Additional Module", namespace: "thebrent", author: "brent@thebrent.net", mnmn: "SmartThings", vid: "SmartThings-smartthings-Xiaomi_Temperature_Humidity_Sensor", ocfDeviceType: "oic.d.thermostat") {
        capability "Sensor"
        capability "Battery"
