...
definition(
    ...
    parent: parent ? "thebrent.Google Home Helper" : null,
...
def mainPageParent() {
	dynamicPage(name: "mainPageParent", title: "Google Home Helper Scenarios", install: true, uninstall: false) {
		section {
			app(name: "childScenarios", appName: "Google Home Helper", namespace: "theBrent", title: "Create New Google Home Scenario...", multiple: true)
		}
		section("Options") {
