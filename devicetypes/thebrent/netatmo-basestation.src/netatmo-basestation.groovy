metadata {
	definition (name: "Netatmo Basestation", namespace: "thebrent", author: "brent@thebrent.net", mnmn: "SmartThings", vid: "SmartThings-smartthings-Xiaomi_Temperature_Humidity_Sensor", ocfDeviceType: "oic.d.thermostat") {
